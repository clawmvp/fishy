...
echipament.push(
  ...
  { nume: "Lowrance Eagle Eye 9", marca: "Lowrance", specific: "Display 9 inch + live sonar integrat (lansare 2026)", prioritate: "must", pentru: ["crap", "salau"], categoria: "sonare", note: "ENTRY-LEVEL LIVE SONAR 2026 — ~5000-8000 RON setup complet (display + sondă inclusă). Range Forward 15-18m (vs LVS34 61m). ⚠️ LIMITARE CRITICĂ pentru CLONC: are 'black zone' aproape de barcă (~3-5m orb) — pierzi exact zona unde atacă somnul. Bună pentru crap pe canale înguste / lacuri mici. Pentru clonc serios → Elite FS + ActiveTarget." },
  { nume: "Lowrance Elite FS 9 + ActiveTarget", marca: "Lowrance", specific: "Display 9 inch + transducer ActiveTarget", prioritate: "expert", pentru: ["crap", "somn", "salau"], categoria: "sonare", note: "BUGET REAL PENTRU CLONC — ~11000-13000 RON total. Elite FS 9 (~5500 RON) + ActiveTarget 1 (~6500 RON, preț scăzut cu 25% în 2026). ✅ FĂRĂ black zone (vezi continuu 0-60m) — vital pentru clonc somn. Diferența vs HDS Pro: ecran mai mic + procesor mai slab, dar aceeași tehnologie live sonar." },
  ...
  { nume: "Lowrance HDS LIVE 9 + ActiveTarget", marca: "Lowrance", specific: "Display 9 inch (generația anterioară Pro) + ActiveTarget", prioritate: "expert", pentru: ["crap", "somn"], categoria: "sonare", note: "MID-PREMIUM pentru clonc serios — ~15000-18000 RON (sau ~9-12k second-hand). ActiveTarget 1 sub 6000 RON acum. ✅ Zero black zone (continuu 0-60m). Ecran și procesor superior Elite FS. Generația anterioară Pro — performantă pentru majoritatea pescarilor." },
