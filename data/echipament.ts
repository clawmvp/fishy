...
echipament.push(
  ...
  // ============ SONARE BUGET + PORTABILE (sub 15k RON) ============
  { nume: "Deeper Smart Sonar CHIRP+ 2", marca: "Deeper", specific: "Portabil castable, CHIRP triplu 100/240/675 kHz (47°/20°/7°), GPS, WiFi 120m", prioritate: "must", pentru: ["crap", "salau", "somn", "stiuca"], categoria: "sonare", note: "~280-320 EUR (~1500 RON). NU e live sonar real — e 2D portabil de aruncat cu lansetă. Excelent pentru: sondare loc înainte de pescuit, marcare buturi pe hartă, partide rapide. Adâncime max 100m. Baterie 15-20h. Cea mai bună soluție portabilă sub 1500 RON." },
  { nume: "Deeper PRO+ 2", marca: "Deeper", specific: "Dual beam 90/290 kHz, GPS, WiFi", prioritate: "nice", pentru: ["crap", "salau", "somn"], categoria: "sonare", note: "~200-250 EUR. Versiune anterioară CHIRP+ 2 — fără triple CHIRP, doar dual beam. Bun pt început dacă găsești la ofertă sau second-hand." },
  { nume: "Lowrance Eagle Eye 9 (all-in-one)", marca: "Lowrance", specific: "Display 9 inch + live sonar INTEGRAT (sondă forward-facing inclusă) — lansare 2026", prioritate: "must", pentru: ["crap", "salau"], categoria: "sonare", note: "ENTRY-LEVEL LIVE SONAR 2026 — ~5000-8000 RON setup COMPLET (NU mai cumperi nimic separat, sondă inclusă). Range Forward 15-18m (vs ActiveTarget 60m). ⚠️ LIMITARE CRITICĂ pentru CLONC: are 'black zone' aproape de barcă (~3-5m orb) — pierzi exact zona unde atacă somnul. Bună pentru crap pe canale înguste / lacuri mici. Pentru clonc serios → Elite FS + ActiveTarget (combo) sau HDS LIVE + ActiveTarget." },
  { nume: "Lowrance Elite FS 9 + ActiveTarget (achiziție SEPARATĂ)", marca: "Lowrance", specific: "Display 9 inch + transducer ActiveTarget cumpărat separat", prioritate: "expert", pentru: ["crap", "somn", "salau"], categoria: "sonare", note: "⚠️ ATENȚIE TERMENI: Elite FS STANDALONE (~5500 RON) vine doar cu ActiveImaging 3-in-1 (NU live sonar — doar 2D + DownScan + SideScan). Pentru LIVE sonar la clonc trebuie ADĂUGAT separat transducer ActiveTarget (~6500 RON AT1 / 7500 RON AT2). TOTAL combo: ~11000-13000 RON. ✅ Compatibilitate confirmată oficial Lowrance — modurile Forward/Down/Scout. ✅ FĂRĂ black zone — vezi continuu 0-60m. Diferența vs HDS Pro: ecran mai mic + procesor mai slab, dar aceeași tehnologie live." },
  { nume: "Humminbird Helix 9 + MEGA Live 1 (achiziție SEPARATĂ)", marca: "Humminbird", specific: "Display 9 inch + transducer MEGA Live cumpărat separat", prioritate: "expert", pentru: ["crap", "somn", "salau"], categoria: "sonare", note: "MID-TIER LIVE SONAR generația 1 — ~12000-14000 RON combo. ✅ Forward + Down. Comunitate RO mai mică decât Lowrance/Garmin." },
  { nume: "Humminbird Helix 9 + MEGA Live 2 (achiziție SEPARATĂ)", marca: "Humminbird", specific: "Display 9 inch + MEGA Live 2 transducer (lansare 2024)", prioritate: "expert", pentru: ["crap", "somn", "salau"], categoria: "sonare", note: "MID-TIER LIVE SONAR generația 2 — ~12500-15000 RON combo. MEGA Live 2 transducer ~7500 RON. ✅ Forward + Down + Landscape (similar Scout Lowrance). Compatibil display Helix MEGA, APEX, XPLORE, SOLIX G3. Compatibil motor Minn Kota Ultrex/Fortrex/Maxxum/Edge. Alternativă reală la ActiveTarget 2." },
  { nume: "Humminbird APEX 13 + MEGA Live 2", marca: "Humminbird", specific: "Display 13 inch premium + MEGA Live 2", prioritate: "expert", pentru: ["crap", "somn"], categoria: "sonare", note: "PREMIUM Humminbird — ~22000-26000 RON combo. Ecran mai mare + procesor superior. Alternativă la Lowrance HDS Pro / Garmin GPSMAP." },
  { nume: "Raymarine Axiom RealVision 3D", marca: "Raymarine", specific: "RealVision 3D imaging (NU live forward-facing real)", prioritate: "nice", pentru: ["crap"], categoria: "sonare", note: "⚠️ Raymarine NU este încă opțiune serioasă pentru clonc în 2026. RealVision e 3D imaging, NU live forward-facing real. Folosit mai mult pentru marine/offshore. Pentru clonc Delta → preferă Garmin/Lowrance/Humminbird." },
  { nume: "Lowrance HDS LIVE 9 + ActiveTarget (achiziție SEPARATĂ)", marca: "Lowrance", specific: "Display 9 inch + transducer ActiveTarget cumpărat separat", prioritate: "expert", pentru: ["crap", "somn"], categoria: "sonare", note: "MID-PREMIUM pentru clonc serios — ~15000-18000 RON (sau ~9-12k second-hand). Display HDS LIVE 9 + ActiveTarget 1 (~6500 RON). Compatibilitate oficială Lowrance. ✅ Zero black zone (continuu 0-60m). Ecran și procesor superior Elite FS — refresh rate mai bun, split-screen avansat. Generația anterioară Pro — performantă pentru majoritatea pescarilor." },

  // ============ BĂRCI (cabinate / podine pentru Delta + Dunăre) ============
  { nume: "Finval 595", marca: "Finval", specific: "5.95 m, cabinata, V semi-plat", prioritate: "expert", pentru: ["crap", "salau", "somn"], categoria: "barci", note: "Standardul GFT pentru Sulina/Mila 23. Setup confirmat: motor electric Quest + Live Scope LVS34 pe baterie LiFePO4 36V/100Ah. ~120.000-150.000 RON setup complet." },
  { nume: "Mary Fisher / Merry Fisher 695", marca: "Mary Fisher", specific: "6.95 m, cabinata mare, V-hull", prioritate: "expert", pentru: ["crap", "somn"], categoria: "barci", note: "Folosită de Gigant Fish pentru canalele Mila 23. Spațiu confortabil pentru 2-3 pescari + sonar montat permanent. ~180.000-220.000 RON." },
  { nume: "Gobbi 5m × 2m cabinata", marca: "Gobbi", specific: "5.0 m, cabinata cu Bimini top", prioritate: "expert", pentru: ["crap", "somn"], categoria: "barci", note: "Setup PCS 2025 — Suzuki 40 CP trim electric, scaun rotativ 360°, sonar pe timonă demontabil. Confort superior vs cort. ~80.000-100.000 RON." },
  { nume: "Cabinata entry-level 4.5-5 m", specific: "4.5-5 m + motor termic 15-25 CP", prioritate: "must", pentru: ["crap", "salau", "somn"], categoria: "barci", note: "Dimensiune minimă pentru partide 2-3 zile cu cortul pe Dunăre/Delta. Spațiu pentru 2 pescari + bagaj. Buget total ~30.000-50.000 RON cu motor uzat second-hand." },
  ...
  // ============ ACCESORII BARCĂ ============
  { nume: "Cort barcă Husky Bizam 2 Plus", marca: "Husky", specific: "2 persoane, 2 ieșiri prova+pupa", prioritate: "must", pentru: ["crap", "somn"], categoria: "accesorii", note: "~580 RON. SINGURA opțiune LEGALĂ pentru dormit pe apele Deltei (cortul pe mal = amendă ARBDD 5000 RON)." },
  { nume: "Bimini top universal", specific: "Acoperiș desfăcut cabină, 200x180 cm", prioritate: "nice", pentru: ["crap"], categoria: "accesorii", note: "Pentru protecție soare/ploaie pe cabinate fără punte. Standard pe Gobbi 5m." },
  { nume: "Scaun rotativ 360° cu suport detașabil", specific: "Pivot 360°, suport reglabil", prioritate: "nice", pentru: ["crap"], categoria: "accesorii", note: "Confort superior la așezat 10+ ore. Pe Gobbi PCS, montaj cu suport detașabil." },
);
