...
echipament.push(
  ...
  { nume: "Lowrance Eagle Eye 9", marca: "Lowrance", specific: "Display 9 inch + live sonar integrat (lansare 2026)", prioritate: "must", pentru: ["crap", "somn", "salau"], categoria: "sonare", note: "ENTRY-LEVEL LIVE SONAR 2026 — ~6000-8000 RON setup complet (display + sondă inclusă). Nu egalează LVS34/ActiveTarget 2 ca rezoluție, dar acces real la forward-facing sonar fără 15k+." },
  { nume: "Lowrance Elite FS 9 + ActiveTarget", marca: "Lowrance", specific: "Display 9 inch + transducer ActiveTarget", prioritate: "expert", pentru: ["crap", "somn", "salau"], categoria: "sonare", note: "BUGET COMPATIBIL ActiveTarget — ~11000-13000 RON total. Elite FS 9 (~5500 RON) + ActiveTarget 1 (~6500 RON). Diferența vs HDS Pro: ecran mai mic + procesor mai slab, dar aceeași tehnologie live sonar." },
